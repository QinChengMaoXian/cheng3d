...
export enum TexTarget {
    TEXTURE_2D,
    TEXTURE_CUBE_MAP_POSITIVE_X, // 右
    TEXTURE_CUBE_MAP_NEGATIVE_X, // 左
    TEXTURE_CUBE_MAP_POSITIVE_Y, // 上
    TEXTURE_CUBE_MAP_NEGATIVE_Y, // 下
    TEXTURE_CUBE_MAP_POSITIVE_Z, // 后
    TEXTURE_CUBE_MAP_NEGATIVE_Z, // 前
}
